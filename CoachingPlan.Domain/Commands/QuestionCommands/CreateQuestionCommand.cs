...
namespace CoachingPlan.Domain.Commands.QuestionCommands
{
    public class CreateQuestionCommand
    {
        ...
        public CreateQuestionCommand(ETypeReply typeReply, ETypeQuestion typeQuestion, int stepQuestion, string enunciation, string education, ICollection<Reply> reply, int? phaseQuestion)
        {
