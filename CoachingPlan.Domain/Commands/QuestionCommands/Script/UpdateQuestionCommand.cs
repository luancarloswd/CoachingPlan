...
{
    public class UpdateQuestionCommandScript
    {
        ...
        public UpdateQuestionCommandScript(Guid id, ETypeReply typeReply, ETypeQuestion typeQuestion, int stepQuestion, string enunciation, string education, ICollection<Reply> reply)
        {
            this.Id = id;
