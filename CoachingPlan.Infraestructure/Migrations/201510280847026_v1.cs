    ...
    public partial class v1 : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        a14_Id_Plano_Acao_a11 = c.Guid(),
                    })
                .PrimaryKey(t => t.Id_Processo_Coaching)
                .ForeignKey("dbo.a13_Plano_Acao_tb", t => t.a14_Id_Plano_Acao_a11)
                .Index(t => t.a14_Id_Plano_Acao_a11);
            
            CreateTable(
                "dbo.a18_Orcamento_tb",
                c => new
                    {
                        Id_Orcamento = c.Guid(nullable: false, identity: true),
                        a11_Id_Processo_a18 = c.Guid(nullable: false),
                        ...
                        Status_Orcamento = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id_Orcamento)
                .ForeignKey("dbo.a11_Processo_Coaching_tb", t => t.a11_Id_Processo_a18, cascadeDelete: true)
                .Index(t => t.a11_Id_Processo_a18);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.a12_Sessao_tb", t => t.a12_fk_sessao_t11, cascadeDelete: true)
                .Index(t => t.a5_fk_coach_t11)
                .Index(t => t.a12_fk_sessao_t11);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.a12_Sessao_tb", t => t.a12_fk_sessao_t12, cascadeDelete: true)
                .Index(t => t.a5_fk_coachee_t12)
                .Index(t => t.a12_fk_sessao_t12);
            ...
            CreateTable(
                "dbo.t6_Prnchmnt_Frmt_Coachee_tb",
                c => new
                    {
                ...
                c => new
                    {
                        ...
                        Author_Frmt_Avaliacao = c.String(nullable: false, maxLength: 60, storeType: "nvarchar"),
                        Tipo_Frmt_Avaliacao = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id_Frmt_Avaliacao);
            
            CreateTable(
                "dbo.t13_Prnchnt_Frmt_Coach_tb",
                c => new
                    {
                        Id_Resposta = c.Guid(nullable: false, identity: true),
                ...
                .ForeignKey("dbo.a11_Processo_Coaching_tb", t => t.a11_Id_Processo_t13, cascadeDelete: true)
                .ForeignKey("dbo.a19_Frmt_Avaliacao_tb", t => t.a20_Id_Frmt_Avaliacao_t13, cascadeDelete: true)
                .Index(t => t.a20_Id_Frmt_Avaliacao_t13)
                .Index(t => t.a5_Id_Coach_t13)
                .Index(t => t.a11_Id_Processo_t13);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.a19_Frmt_Avaliacao_tb", t => t.a19_Id_Frmt_Avlc_a21, cascadeDelete: true)
                .Index(t => t.a19_Id_Frmt_Avlc_a21);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id_Resposta = c.Guid(nullable: false, identity: true),
                        a20_Id_Questao_a22 = c.Guid(nullable: false),
                        Resposta = c.String(nullable: false, unicode: false),
                        Situacao_Resposta = c.Boolean(nullable: false),
                        Grupo_Resposta = c.String(maxLength: 20, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.Id_Resposta)
                .ForeignKey("dbo.a20_Questao_tb", t => t.a20_Id_Questao_a22, cascadeDelete: true)
                .Index(t => t.a20_Id_Questao_a22);
            ...
            CreateTable(
                "dbo.a22_Menssagem_tb",
                c => new
                    {
                        Id_Menssagem = c.Guid(nullable: false, identity: true),
                        a4_Id_Usuario_a22 = c.String(nullable: false, maxLength: 200, storeType: "nvarchar"),
                        Menssagem = c.String(nullable: false, unicode: false),
                        Destino_Menssagem = c.String(nullable: false, unicode: false),
                ...
                .ForeignKey("dbo.a4_usuario_tb", t => t.a4_Id_Usuario_a22, cascadeDelete: true)
                .Index(t => t.a4_Id_Usuario_a22);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        a12_Id_Sessao_a17 = c.Guid(),
                        a15_Id_Meta_a17 = c.Guid(nullable: false),
                ...
                .ForeignKey("dbo.a15_Meta_tb", t => t.a15_Id_Meta_a17, cascadeDelete: true)
                .ForeignKey("dbo.a12_Sessao_tb", t => t.a12_Id_Sessao_a17)
                .Index(t => t.a12_Id_Sessao_a17)
                .Index(t => t.a15_Id_Meta_a17);
                ...
                c => new
                    {
                        ...
                        a14_Id_Objective_a16 = c.Guid(nullable: false),
                        Prazo_Meta = c.DateTime(nullable: false, storeType: "date"),
                        Descricao_Meta = c.String(unicode: false),
                    })
                .PrimaryKey(t => t.Id_Meta)
                .ForeignKey("dbo.a14_Objetivo_tb", t => t.a14_Id_Objective_a16, cascadeDelete: true)
                .Index(t => t.a14_Id_Objective_a16);
                ...
                c => new
                    {
                        ...
                        a13_Id_Plano_a15 = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Id_Objetivo)
                .ForeignKey("dbo.a13_Plano_Acao_tb", t => t.a13_Id_Plano_a15, cascadeDelete: true)
                .Index(t => t.a13_Id_Plano_a15);
            ...
            CreateTable(
                ...
                .Index(t => t.Nome_Servico, unique: true, name: "IX_NOME_SERVICO");
                ...
                c => new
                    {
                        ...
                        a19_Id_Ferramenta_t9 = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => new { t.a5_Id_Coach_t9, t.a19_Id_Ferramenta_t9 })
                .ForeignKey("dbo.a19_Frmt_Avaliacao_tb", t => t.a5_Id_Coach_t9, cascadeDelete: true)
                .ForeignKey("dbo.a5_coach_tb", t => t.a19_Id_Ferramenta_t9, cascadeDelete: true)
                .Index(t => t.a5_Id_Coach_t9)
                .Index(t => t.a19_Id_Ferramenta_t9);
            
            CreateTable(
                "dbo.t10_servico_processo_tb",
                c => new
                    {
                        a17_Id_Servico_t10 = c.Guid(nullable: false),
                        a11_Id_Processo_t10 = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => new { t.a17_Id_Servico_t10, t.a11_Id_Processo_t10 })
                .ForeignKey("dbo.a17_Servico_tb", t => t.a17_Id_Servico_t10, cascadeDelete: true)
                .ForeignKey("dbo.a11_Processo_Coaching_tb", t => t.a11_Id_Processo_t10, cascadeDelete: true)
                .Index(t => t.a17_Id_Servico_t10)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.t10_servico_processo_tb", "a17_Id_Servico_t10", "dbo.a17_Servico_tb");
            ...
            DropForeignKey("dbo.t11_coach_avaliacao_tb", "a12_fk_sessao_t11", "dbo.a12_Sessao_tb");
            DropForeignKey("dbo.a12_Sessao_tb", "a4_Id_Usuario_a12", "dbo.a4_usuario_tb");
            DropForeignKey("dbo.a16_Tarefa_tb", "a12_Id_Sessao_a17", "dbo.a12_Sessao_tb");
            DropForeignKey("dbo.a16_Tarefa_tb", "a15_Id_Meta_a17", "dbo.a15_Meta_tb");
            DropForeignKey("dbo.a15_Meta_tb", "a14_Id_Objective_a16", "dbo.a14_Objetivo_tb");
            DropForeignKey("dbo.a14_Objetivo_tb", "a13_Id_Plano_a15", "dbo.a13_Plano_Acao_tb");
            DropForeignKey("dbo.t12_coachee_avaliacao_tb", "a12_fk_sessao_t12", "dbo.a12_Sessao_tb");
            DropForeignKey("dbo.t12_coachee_avaliacao_tb", "a5_fk_coachee_t12", "dbo.a8_coachee_tb");
            ...
            DropForeignKey("dbo.a22_Menssagem_tb", "a4_Id_Usuario_a22", "dbo.a4_usuario_tb");
            DropForeignKey("dbo.a9_ponto_forte_tb", "a8_Id_Coachee_a9", "dbo.a8_coachee_tb");
            DropForeignKey("dbo.t6_Prnchmnt_Frmt_Coachee_tb", "a20_Id_Frmt_Avaliacao_t6", "dbo.a19_Frmt_Avaliacao_tb");
            DropForeignKey("dbo.a21_Resposta_tb", "a20_Id_Questao_a22", "dbo.a20_Questao_tb");
            DropForeignKey("dbo.a20_Questao_tb", "a19_Id_Frmt_Avlc_a21", "dbo.a19_Frmt_Avaliacao_tb");
            DropForeignKey("dbo.t13_Prnchnt_Frmt_Coach_tb", "a20_Id_Frmt_Avaliacao_t13", "dbo.a19_Frmt_Avaliacao_tb");
            DropForeignKey("dbo.t13_Prnchnt_Frmt_Coach_tb", "a11_Id_Processo_t13", "dbo.a11_Processo_Coaching_tb");
            ...
            DropForeignKey("dbo.t11_coach_avaliacao_tb", "a5_fk_coach_t11", "dbo.a5_coach_tb");
            ...
            DropForeignKey("dbo.a18_Orcamento_tb", "a11_Id_Processo_a18", "dbo.a11_Processo_Coaching_tb");
            DropForeignKey("dbo.a11_Processo_Coaching_tb", "a14_Id_Plano_Acao_a11", "dbo.a13_Plano_Acao_tb");
            DropIndex("dbo.t10_servico_processo_tb", new[] { "a11_Id_Processo_t10" });
            DropIndex("dbo.t10_servico_processo_tb", new[] { "a17_Id_Servico_t10" });
            DropIndex("dbo.t9_coach_ferramenta_tb", new[] { "a19_Id_Ferramenta_t9" });
            ...
            DropIndex("dbo.a17_Servico_tb", "IX_NOME_SERVICO");
            ...
            DropIndex("dbo.a14_Objetivo_tb", new[] { "a13_Id_Plano_a15" });
            DropIndex("dbo.a15_Meta_tb", new[] { "a14_Id_Objective_a16" });
            DropIndex("dbo.a16_Tarefa_tb", new[] { "a15_Id_Meta_a17" });
            DropIndex("dbo.a16_Tarefa_tb", new[] { "a12_Id_Sessao_a17" });
            ...
            DropIndex("dbo.a22_Menssagem_tb", new[] { "a4_Id_Usuario_a22" });
            ...
            DropIndex("dbo.a21_Resposta_tb", new[] { "a20_Id_Questao_a22" });
            DropIndex("dbo.a20_Questao_tb", new[] { "a19_Id_Frmt_Avlc_a21" });
            ...
            DropIndex("dbo.t12_coachee_avaliacao_tb", new[] { "a5_fk_coachee_t12" });
            DropIndex("dbo.a12_Sessao_tb", new[] { "a4_Id_Usuario_a12" });
            DropIndex("dbo.a12_Sessao_tb", new[] { "a11_Id_Processo_a12" });
            DropIndex("dbo.t11_coach_avaliacao_tb", new[] { "a12_fk_sessao_t11" });
            DropIndex("dbo.t11_coach_avaliacao_tb", new[] { "a5_fk_coach_t11" });
            DropIndex("dbo.a5_coach_tb", new[] { "a4_Id_Usuario_a5" });
            DropIndex("dbo.a18_Orcamento_tb", new[] { "a11_Id_Processo_a18" });
            DropIndex("dbo.a11_Processo_Coaching_tb", new[] { "a14_Id_Plano_Acao_a11" });
            ...
            DropTable("dbo.a17_Servico_tb");
            DropTable("dbo.t5_Incdr_Desempenho_tb");
            DropTable("dbo.a7_especialidade_tb");
            DropTable("dbo.a6_formacao_tb");
            DropTable("dbo.a14_Objetivo_tb");
            DropTable("dbo.a15_Meta_tb");
            DropTable("dbo.a16_Tarefa_tb");
            ...
            DropTable("dbo.a22_Menssagem_tb");
            DropTable("dbo.t1_logins_tb");
            DropTable("dbo.t2_claims_tb");
            DropTable("dbo.a4_usuario_tb");
            DropTable("dbo.a9_ponto_forte_tb");
            DropTable("dbo.a21_Resposta_tb");
            DropTable("dbo.a20_Questao_tb");
            DropTable("dbo.t13_Prnchnt_Frmt_Coach_tb");
            DropTable("dbo.a19_Frmt_Avaliacao_tb");
            DropTable("dbo.t6_Prnchmnt_Frmt_Coachee_tb");
            DropTable("dbo.a8_coachee_tb");
            DropTable("dbo.t12_coachee_avaliacao_tb");
            DropTable("dbo.a12_Sessao_tb");
            DropTable("dbo.t11_coach_avaliacao_tb");
            DropTable("dbo.a5_coach_tb");
            DropTable("dbo.a18_Orcamento_tb");
            DropTable("dbo.a11_Processo_Coaching_tb");
            DropTable("dbo.a13_Plano_Acao_tb");
        }
    }
}
